...
<!-- 				<li class="current"><a href="PB_SC_281.html">게시판 관리</a></li>
				...
				<li class="current"><a href="javascript:alert('준비중입니다');">게시판 관리</a></li>
				<li><a href="javascript:alert('준비중입니다');">정보관리</a></li>
				<li><a href="javascript:alert('준비중입니다');">OPEN API 관리</a></li>
				<li><a href="javascript:alert('준비중입니다');">통계 관리</a></li>
				<li><a href="javascript:alert('준비중입니다');">유통 관리</a></li>
				<li><a href="javascript:alert('준비중입니다');">데이터 관리</a></li>
				<li><a href="javascript:alert('준비중입니다');">기관사용자변경</a></li>
			</ul>
        </nav>
    </header>
	...
	<article class="container">
		...
		<section id="lnb" class="lnb">
			...
			<ul role="menu">
				...
				<li><a href="/QnA/qnaPageList.do">Q&amp;A</a></li>
				<li><a href="javascript:alert('준비중입니다');">국립공원 등산로 지도</a></li>
				<li><a href="javascript:alert('준비중입니다');">공지사항 알림</a></li>
				<li class="current"><a href="javascript:alert('준비중입니다');">극지 동영상</a></li>
				<li><a href="javascript:alert('준비중입니다');">극지사진 갤러리</a></li>
				<li><a href="javascript:alert('준비중입니다');">극지지도 내려받기</a></li>
				<li><a href="javascript:alert('준비중입니다');">GNSS 커뮤니티</a></li>
			</ul>
		</section>
		<!-- /Sub Menu -->
