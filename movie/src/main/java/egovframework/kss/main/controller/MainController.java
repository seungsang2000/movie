...
public class MainController {
	...
	public String mainPage(Model model) {
		...
		fetchGenres(genreMap); //장르 id와 이름 가져오기

		List<Movie> movies = fetchPopularMovies(genreMap); // 인기 영화 정보 가져오기
		model.addAttribute("popularMovies", movies);

		movies = upComingMovies(genreMap);
		model.addAttribute("upComingMovies", movies);

		movies = topRatedMovies(genreMap);
		model.addAttribute("topRatedMovies", movies);

		List<Person> persons = popularPeople();
		model.addAttribute("popularPeople", persons);

		return "home";
	}

	private void fetchGenres(Map<Integer, String> genreMap) {
	...
	private List<Movie> fetchPopularMovies(Map<Integer, String> genreMap) {
	...
	private List<Movie> upComingMovies(Map<Integer, String> genreMap) {
		List<Movie> movies = new ArrayList<>();
	...
	private List<Movie> topRatedMovies(Map<Integer, String> genreMap) {
		List<Movie> movies = new ArrayList<>();
